package com.candyrom.wakeblock;
...
public class WakeBlockService
{
	...
	private final Intent serviceIntent = new Intent("com.candyrom.wakeblock.Service");
	...
	private WakeBlockService()
	{
		...
		this.serviceIntent.setPackage("com.candyrom.wakeblock");
	}
	...
	{
		if (packageName.equals("com.candyrom.wakeblock") && tag.equals("service_bind")) {
